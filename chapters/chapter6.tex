...
\newthought{As} I discussed in Chapter 5, that in order to get the missing information for future flexible optoelectronics based on nanoscale building blocks, light, force and electrical currents are all important factors to be included into {\em in siu} a probing experiment. 
